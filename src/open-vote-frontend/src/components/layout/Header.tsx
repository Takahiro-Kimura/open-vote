    ...
    <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 z-50 flex justify-center items-center">
      <div className="bg-white p-4 rounded-lg shadow-md w-full max-w-md">
        <div className="flex items-center justify-center mb-4">
          ...
          <h2 className="text-lg font-bold text-center">OpenVoteとは</h2>
        </div>
        {children}
  ...
  return (
    <>
      ...
      <Modal isOpen={isModalOpen} onClose={closeModal}>
        <p>
          OpenVoteは、Internet Computer上で動く完全ブロックチェーン型の投票アプリ です！
          すべての処理がブロックチェーン上で行われるので、改ざんの心配なし。誰でも投票結果を確認できるから、透明性もバッチリです。

          さらに、中央管理者なしで動く分散型システム だから、公正な投票が簡単に実現できます。使い方もシンプルで、すぐに投票を作成したり、参加したりできます。

          信頼できる新しい投票のカタチ、試してみませんか？
        </p>
      </Modal>
    </>
  );
